...
- 근본 원인은 AI의 "판단 오류"가 아니라 블루투스 PIN 인증이 취약해 최대 450피트(약 130m) 밖에서 접속·탈취가 가능했던 보안 설계 결함. 2024-08-08~11 DEF CON 32에서 연구자 Dennis Giese·Braelynn Luedtke가 이 취약점을 공개 발표했다 (source: [TechCrunch](https://techcrunch.com/2024/08/09/ecovacs-home-robots-can-be-hacked-to-spy-on-their-owners-researchers-say/)). [2026-09-21 verifier 확인] 2024-05-24 미네소타·LA 사건, DEF CON 32(2024-08) 발표, 엘패소 별도 피해 사례 모두 재검색으로 교차확인됨(ABC News, incidentdatabase.ai #842, Malwarebytes, Android Authority 등 다수 매체 일치).
...
- Amazon은 2025-04 "Buy for Me" 기능을 발표, Amazon 쇼핑 앱 안에서 AI가 타 브랜드 웹사이트 상품을 대신 구매해주는 기능을 시작했다 (source: [Retail Dive](https://www.retaildive.com/news/amazon-buy-for-me-agentic-ai-third-party-sites/745047/)). [2026-09-21 verifier 확인] TechCrunch 원문(2025-04-03 "Amazon's new AI agent will shop third-party stores for you")으로 2025-04 출시 및 2026-01 반발 확산(SiliconANGLE 2026-01-06, CNBC 2026-01-06) 모두 교차확인됨.
...
- **2026년 현재 상황**: Gemini로 전환된 Google Home 앱의 최근 리뷰 4,000건(2026-04-13~2026-09-08, 147일간)을 분석한 결과 53.1%가 별점 1점이었고, 120자 이상 구체적 불만을 남긴 1,340건 중 136건이 명시적으로 "Assistant→Gemini 전환"을 원인으로 지목했다 — 이 비율은 5개월간 거의 변하지 않았다 (source: [Unstar](https://unstar.app/blog/google-home-gemini-voice-commands-worse-reviews-2026), WebSearch로 확인, 원문 직접 인용은 WebFetch 차단으로 미검증). 사용자들은 "음성 인식이 더 불안정해졌고 앱이 느려졌으며 이전 버전으로 돌아갈 공식적인 방법이 없다"고 지적한다. [2026-09-21 verifier 확인] 4,000건·53.1%·147일(2026-04-13~09-08)·136건 수치를 재검색으로 재확인함(검색 스니펫이 원문과 정확히 일치, 별도의 독립 검색 질의로도 동일 수치 재현됨) — 다만 이 통계는 Unstar라는 단일 블로그의 자체 분석(공식 학술·업계 리서치 기관 아님)이며, 방법론(리뷰 수집 방식, 감성분류 기준)이 별도로 공개 검증되지는 않았다는 한계는 유지된다(Unverifiable claims 참고).
...
- **시행 시기(2026년 최신 변경 사항, 매우 중요)**: 원래 Annex III 고위험 의무는 2026-08-02부터 적용될 예정이었으나, 2026년 옴니버스 개정(Regulation (EU) 2026/1744, 2026-07-24 공포, 2026-07-27 발효)으로 **독립형(standalone) 고위험 AI 시스템(Annex III) 의무는 2027-12-02로, 이미 EU 제품안전법 적용을 받는 제품에 내장된 AI(Annex I) 의무는 2028-08-02로 각각 연기**되었다. 다만 제50조(투명성·AI 생성 콘텐츠 라벨링), GPAI(범용 AI) 제공자 의무(2025-08-02부터 이미 적용 중), 제5조 금지행위 규제(2025-02-02부터 이미 적용 중)는 원래 일정대로 유지된다 (source: [Gibson Dunn](https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/), [Cloud Security Alliance](https://labs.cloudsecurityalliance.org/research/csa-research-note-eu-ai-act-high-risk-deadline-omnibus-20260/)). [2026-09-21 verifier 확인] Regulation (EU) 2026/1744 공포일(2026-07-24)·발효일(2026-07-27)·Annex III 유예 시한(2027-12-02)·Annex I 유예 시한(2028-08-02), 그리고 제5조(2025-02-02)·GPAI(2025-08-02)·제50조는 원 일정 유지라는 서술 모두 재검색으로 정확히 일치 확인됨(Cloud Security Alliance, Modulos, White & Case, alpacax 등 다수 매체 일치). Annex III 8개 영역에 스마트홈/일반가전이 명시적으로 포함되지 않는다는 서술, "핵심 인프라" 항목은 "critical entity로 지정된 배포자"가 전기·가스·난방·수도 공급의 안전 구성요소로 쓸 때만 해당한다는 조건(일반 가정은 critical entity가 아님)도 euaiact.com/artificialintelligenceact.eu 교차확인으로 뒷받침됨 — 즉 파일의 "스마트홈 일반 가전은 8개 고위험 영역에 해당하지 않는다"는 결론은 추가 근거로 더 강하게 뒷받침된다.
