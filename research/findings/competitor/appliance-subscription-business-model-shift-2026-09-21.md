...
- 대신 **2026년 6월 발표(보도 확산일 2026-06-26), 2026년 10월 시행 예정으로 SmartThings API에
  ...
  [2026-09-21 verifier 확인] $4.99/월·2026년 10월 시행 재검색 교차확인됨(`home-ai-standard-war-2026-09-21.md` 검증과 동일 결과).
...
1. **이미 검증된 것 (확장 여지 제한적)**: 하드웨어 렌탈+케어십형 구독(LG 시그니처/SKS 전용,
   정기방문 위생관리 등) — 이미 상당 규모로 운영 중이며([2026-09-21 verifier 확인] 이 "29% 성장"
   수치는 LG전자 자체 가전구독 매출 성장률로, 위 Key findings 5번 정정 사항 참고 — "시장 전체
   성숙기"가 아니라 "LG 자체 사업의 성숙기 근접"으로 읽어야 함), 이는 신규 카테고리 확장이라기보다
   기존 렌탈 사업의 자연 성장일 가능성이 큼.
