...
## 자사(LG) 25~26년 활동 서술 규칙 — 27년 방향성 근거로만 사용 (2026-09-22 사용자 지시)

최종 산출물(`research/reports/` 마크다운, 이를 옮긴 아티팩트, PPT)에서 자사(LG전자)가
**2025~2026년에 한 일 자체를 독립된 사실/섹션/불릿으로 나열하지 않는다.** 자사의 25~26년
활동은 **2027년 방향성을 제안하는 근거로만** 쓴다 — 즉 "26년에 이거 했으니, 27년에는 이걸 하면
좋겠다"처럼 27년 추천 문장에 녹여서만 등장해야 하고, "26년에 LG가 OOO를 했다"는 문장이 그
자체로 하나의 항목이 되어서는 안 된다. (경쟁사 동향에 적용되는 위의 "2026-only" 규칙과는
별개 — 그 규칙은 경쟁사·업계에 대한 "현재 상황" 서술에 적용되는 것이고, 이 규칙은 자사 활동을
27년 제안과 분리해서 단독으로 보여주지 말라는 것.)

이 규칙은 report-writer가 만드는 최종 문서에 적용되는 것이며, `research/findings/own-company/`
밑에 원본 사실을 리서치·기록하는 것 자체는 계속 허용된다 — report-writer가 그 사실을 최종
산출물로 옮길 때 반드시 27년 제안과 짝지어서만 옮긴다는 뜻. 이 규칙은 `report-writer` 에이전트
정의 파일에도 동일하게 반영되어 있다.
